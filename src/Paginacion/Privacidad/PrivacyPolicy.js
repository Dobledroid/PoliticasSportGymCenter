  ...
  return (
    ...
    <Container className="privacy-policy-container">
      <div style={styles.container}>
        ...
        <section style={styles.section}>
          <h3 style={styles.h3}>¿Para qué fines utilizaremos sus datos personales?</h3>
          <p style={styles.p}>
        ...
        <section style={styles.section}>
          <h3 style={styles.h3}>¿Qué datos personales utilizaremos para estos fines?</h3>
          <p style={styles.p}>
        ...
        <section style={styles.section}>
          <h3 style={styles.h3}>¿Con quién compartimos su información personal y para qué fines?</h3>
          <p style={styles.p}>
            ...
            <table class="table table-bordered">
              ...
              <tbody>
                ...
                <tr>
                  <th scope="row">Google Analytic</th>
                  <td>Publicidad y análisis para la mejora continua</td>
                  <td>No</td>
                </tr>
                <tr>
                  <th scope="row">Servicios de pago en linea</th>
        ...
        <section style={styles.section}>
          <h3 style={styles.h3}>¿Cómo puede acceder, rectificar o cancelar sus datos personales, u oponerse a su uso?</h3>
          <p style={styles.p}>
        ...
        <section style={styles.section}>
          <h3 style={styles.h3}>Usted puede revocar su consentimiento para el uso de sus datos personales</h3>
          <p style={styles.p}>
        ...
        <section style={styles.section}>
          <h3 style={styles.h3}>¿Cómo puede limitar el uso o divulgación de su información personal?</h3>
          <p style={styles.p}>
        ...
        <section style={styles.section}>
          <h3 style={styles.h3}>El uso de tecnologías de rastreo en nuestro portal de internet</h3>
          <p style={styles.p}>
        ...
        <section style={styles.section}>
          <h3 style={styles.h3}>¿Cómo puede conocer los cambios en este aviso de privacidad?</h3>
          <p style={styles.p}>
            ...
            El Responsable del tratamiento de datos personales publicará los cambios o actualizaciones del aviso de privacidad en su portal de internet dentro de los 15 días hábiles siguientes a la fecha en que se efectúen. También enviará un correo electrónico a los titulares que hayan proporcionado su dirección de correo electrónico, notificándoles los cambios o actualizaciones realizados al aviso de privacidad. El correo electrónico deberá contener la siguiente información: Fecha de publicación de los cambios o actualizaciones. Descripción de los cambios o actualizaciones realizados. Enlace al aviso de privacidad actualizado. Los titulares podrán consultar el aviso de privacidad actualizado en cualquier momento en el portal de internet del Responsable del tratamiento de datos personales. Ejemplo de correo electrónico: Asunto: Cambios al aviso de privacidad Estimado titular: Le informamos que hemos realizado cambios al aviso de privacidad que regula el tratamiento de sus datos personales. Los cambios o actualizaciones realizados al aviso de privacidad son los siguientes: [Descripción de los cambios o actualizaciones realizados.] Para consultar el aviso de privacidad actualizado, puede visitar nuestro portal de internet en la siguiente dirección: [Enlace al aviso de privacidad actualizado] Agradecemos su atención. Atentamente, [Nombre del Responsable del tratamiento de datos personales]
