        ...
        <div>
          ...
          <section className='my-3'>
            ...
            <div class="card-group">
              <div className="card text-center">
                ...
                <div className="card-body">
                  ...
                  <div className="card-footer">
                    ...
                    <button className="btn btn-dark text-white">¡Lo necesito!</button>
                  </div>
                </div>
              </div>
              ...
              <div className="card">
                <img src="/images/productos/creatine.png" class="card-img-top" alt="quitabarrigas"
                  style={{ maxWidth: '100px', height: '200px' }} />
                <div class="card-body">
              ...
              <div className="card">
                <img src="/images/productos/vegan_protein.png" class="card-img-top" alt="quitabarrigas"
                  style={{ maxWidth: '100px', height: '200px' }} />
                <div class="card-body">
                  <h5 class="card-title">Card title</h5>
                  <p class="card-text">This card has supporting text below as a natural lead-in to additional content.</p>
              ...
              <div className="card">
                <img src="/images/productos/wheb_protein.png" class="card-img-top" alt="quitabarrigas"
                  style={{ maxWidth: '100px', height: '200px' }} />
                <div class="card-body">
                  <h5 class="card-title">Card title</h5>
                  <p class="card-text">This card has supporting text below as a natural lead-in to additional content.</p>
